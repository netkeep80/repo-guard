...
function normalizeFacts(input) {
    ...
    if (typeof input.branch_behind !== "boolean")
        return invalid("branch_behind must be boolean");
    if (typeof input.merged !== "boolean")
        return invalid("merged must be boolean");
    if (typeof input.queued !== "boolean")
        return invalid("queued must be boolean");
    if (typeof input.integrating !== "boolean")
        return invalid("integrating must be boolean");
    if (typeof input.merge_conflict !== "boolean")
        return invalid("merge_conflict must be boolean");
