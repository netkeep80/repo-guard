...
```text
исполняемым регрессионным доказательством
...
Нужны один положительный и один минимальный отрицательный вариант.
...
Запрещено создавать тест, который повторяет семантику политики вместо запуска рабочего интерфейса командной строки.
...
После приёмки C3.5 следующий нормативный этап — C3.6. C3.6 не начинается внутри PR C3.5.
